---
title:
  ko: '[MARL/01] Multi Agent Reinforcement Learning 기초 '
  en: '[MARL/01] Multi Agent Reinforcement Learning Basic '
tags:
- RL
- MARL
pages: papers
...
description:
  ko: 멀티 에이전트 강화학습 기초 이론을 다룬다.
  en: Basic Notion of Multi Agent Reinforcement Learning.
---
